...
#simplest version of espcn with more parameters (espcn2) (6000 epochs, 30 min)
class SupRes(nn.Module):
    ...
    def __init__(self, upscale_factor = 2):
        ...
        self.conv3=nn.Conv2d(in_channels=16, out_channels=3*upscale_factor*upscale_factor, 
