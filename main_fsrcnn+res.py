...
#fsrcnn with residual (10000 epochs, around 55 min)
class SupRes(nn.Module):
    ...
    def __init__(self, upscale_factor = 2):
        ...
        self.su1 = nn.Sequential(      
            nn.PReLU(),
            nn.Conv2d(in_channels=15,out_channels=15,kernel_size=1),                              
            nn.Sigmoid()                      
        )
        ...
        self.su2 = nn.Sequential(      
            nn.PReLU(),   
            nn.Conv2d(in_channels=7,out_channels=7,kernel_size=1),                              
            nn.Sigmoid()                      
        )
